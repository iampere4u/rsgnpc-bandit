        ...
        while true do
            ...
            if inRobbery == true then
                ...
                if alldeath == true then
                    ...
                    npcs = {}
                    inRobbery = false
		    RSGCore.Functions.Notify('All the bandits are down.', 'primary')
                    break
                end
            end
        end
    end)
   RSGCore.Functions.Notify('You were ambushed!', 'primary')
end
...
Citizen.CreateThread(function()
	...
	Citizen.Wait(1000)
		...
		RSGCore.Functions.Notify('You ve been robbed.', 'primary')
                for v,k in pairs(npcs) do
                    DeleteEntity(k)
                end
                npcs = {}
            ...
            if runAway == true then
                ...
                npcs = {}
                inRobbery = false
		RSGCore.Functions.Notify('You managed to escape.', 'primary')
            end
        end
    end
end)
